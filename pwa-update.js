...
class d {
    constructor(t, e) {
        ...
        let o = 0
          , a = -1
          , d = 0;
        const {strings: c, values: {length: f}} = t;
        for (; d < f; ) {
            const t = n.nextNode();
            if (null !== t) {
                if (a++,
                    ...
                    if (e.indexOf(r) >= 0) {
                        ...
                        for (let e = 0; e < o; e++) {
                            ...
                            if ("" === o)
                                ...
                                const t = u.exec(o);
                                null !== t && h(t[2], "$lit$") && (o = o.slice(0, t.index) + t[1] + t[2].slice(0, -"$lit$".length) + t[3]),
...
class w {
    ...
    setValue(t) {
        t === n || _(t) && t === this.value || (this.value = t,
...
class S {
    ...
    commit() {
        ...
        const t = this.__pendingValue;
        t !== n && (_(t) ? t !== this.value && this.__commitText(t) : t instanceof g ? this.__commitTemplateResult(t) : t instanceof Node ? this.__commitNode(t) : y(t) ? this.__commitIterable(t) : t === o ? (this.value = o,
    ...
    __commitText(t) {
        ...
        e === this.endNode.previousSibling && 3 === e.nodeType ? e.data = s : this.__commitNode(document.createTextNode(s)),
        this.value = t
    }
...
;
function U(t, e) {
    const {element: {content: s}, parts: i} = t
    ...
    for (; n.nextNode(); ) {
        ...
        for (t.previousSibling === h && (h = null),
        e.has(t) && (d.push(t),
        null === h && (h = t)),
        null !== h && l++; void 0 !== r && r.index === a; )
            r.index = null !== h ? -1 : r.index - l,
            o = M(i, o),
            r = i[o]
    }
...
const B = (t,e)=>`${t}--${e}`;
let$ = !0;
void 0 === window.ShadyCSS ? $ = !1 : void 0 === window.ShadyCSS.prepareTemplateDom && (console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),
$ = !1);
const j = t=>e=>{
    const s = B(e.type, t);
    let i = k.get(s);
  ...
  , F = (t,e,s)=>{
    ...
    const i = s ? s.element : document.createElement("template")
      ...
      , {length: o} = n;
    if (0 === o)
        return void window.ShadyCSS.prepareTemplateStyles(i, t);
    ...
    s ? function(t, e, s=null) {
        ...
        for (; o.nextNode(); ) {
            for (l++,
            o.currentNode === s && (a = R(e),
            s.parentNode.insertBefore(e, s)); -1 !== r && n[r].index === l; ) {
                if (a > 0) {
                    for (; -1 !== r; )
                        n[r].index += a,
                        r = M(n, r);
    ...
    }(s, r, a.firstChild) : a.insertBefore(r, a.firstChild),
...
class D extends HTMLElement {
    ...
    _requestUpdate(t, e) {
        ...
        if (void 0 !== t) {
            ...
            i._valueHasChanged(this[t], e, n.hasChanged) ? (this._changedProperties.has(t) || this._changedProperties.set(t, e),
            !0 !== n.reflect || 16 & this._updateState || (void 0 === this._reflectingProperties && (this._reflectingProperties = new Map),
            this._reflectingProperties.set(t, n))) : s = !1
        }
    ...
    performUpdate() {
        ...
        t && (1 & this._updateState || (this._updateState = 1 | this._updateState,
        this.firstUpdated(e)),
        this.updated(e))
    }
    _markUpdated() {
...
class Z {
    ...
    get styleSheet() {
        return void 0 === this._styleSheet && (K ? (this._styleSheet = new CSSStyleSheet,
...
class tt extends D {
    ...
    static _getUniqueStyles() {
        const t = this.styles
          , e = [];
        if (Array.isArray(t)) {
            X(t).reduceRight((t,e)=>(t.add(e),
            t), new Set).forEach(t=>e.unshift(t))
        } else
            t && e.push(t);
        return e
    }
...
tt.render = (t,e,s)=>{
    ...
    if (((t,e,s)=>{
        let n = V.get(e);
        void 0 === n && (i(e, e.firstChild),
        V.set(e, n = new S(Object.assign({
            templateFactory: A
        }, s))),
        n.appendInto(e)),
        n.setValue(t),
...
var et = function(t, e, s, i) {
    var n, o = arguments.length, r = o < 3 ? e : null === i ? i = Object.getOwnPropertyDescriptor(e, s) : i;
...
let st = class extends tt {
    constructor() {
        super(...arguments),
        this.swpath = "https://rochonastore.github.io/pwabuilder-sw.js",
    ...
    setupEvents() {
        this.addEventListener("pwaUpdate", async()=>{
            navigator.serviceWorker && (this.swreg = await navigator.serviceWorker.getRegistration(),
...
et([G({
    type: String
})], st.prototype, "swpath", void 0),
et([G({
    type: String
})], st.prototype, "updateevent", void 0),
et([G({
    type: String
})], st.prototype, "updatemessage", void 0),
et([G({
    type: Boolean
})], st.prototype, "readyToAsk", void 0),
et([G({
    type: Boolean
})], st.prototype, "showStorageEstimate", void 0),
et([G({
    type: Boolean
})], st.prototype, "showOfflineToast", void 0),
et([G({
    type: Number
})], st.prototype, "offlineToastDuration", void 0),
et([G({
    type: String
})], st.prototype, "storageUsed", void 0),
st = et([(it = "pwa-update",
t=>"function" == typeof t ? ((t,e)=>(window.customElements.define(t, e),
e))(it, t) : ((t,e)=>{
